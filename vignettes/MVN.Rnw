...
\small{Hacettepe University, Faculty of Medicine, Department of Biostatistics, Ankara, TURKEY}\\[0cm]\textbf{\small{$^1$selcuk.korkmaz@hacettepe.edu.tr}}
} 
\date{\textbf{MVN} version \Sexpr{packageDescription("MVN")$Version}  (Last revision 2015-01-28)}
